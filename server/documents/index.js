...
<section class="address">
      ...
      <p class="title">Bill to:</p>
        <h4 style="font-size: 9px; line-height: 5px">${name ? name : ""}</h4>
        <p style="font-size: 9px; line-height: 5px">${email ? email: "" }</p>
        <p style="font-size: 9px; line-height: 5px">${phone ? phone : ""}</p>
        <p style="font-size: 9px; line-height: 5px">${address? address: "" }</p>
      </div>
